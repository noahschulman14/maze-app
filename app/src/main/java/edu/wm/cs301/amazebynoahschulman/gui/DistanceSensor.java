...
public interface DistanceSensor {
	...
	/**
	 * Method to determine operational status of sensor.
	 * @return operational status of sensor - true if working, false otherwise
	 */
	boolean isOperational();
	
	/**
	 * Method that returns whether or not a sensors background thread is running 
	 * (if that type of sensor has a background thread)
	 * @return thread running status of sensor
	 */
	boolean isRunning();
