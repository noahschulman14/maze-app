...
import edu.wm.cs301.amazebynoahschulman.gui.Constants;
...
public class MazeBuilder implements Runnable {
	...
	public void buildOrder(Order order) {
		...
		width = Constants.SKILL_X[skill]; // NOTE: LOOK AT CONSTANTS CLASS, SKILL_X AND SKILL_Y ARE ARRAY WITH CORRESPONDING SIZES BASED ON skill INDEX
	 ...
	 */
	// NOTE: this is a main method? I'm confused, so this runs like a Main() method? Cuz I don't see run() called in MazeFactory class ?
	public void run() {
